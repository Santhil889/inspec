...
class ADDEXT extends StatefulWidget {
  @override
  _ADDEXTState createState() => _ADDEXTState();
}

class _ADDEXTState extends State<ADDEXT> {
  ...
  putvalues(){
    db.getConnection().then((conn){
      String sql="INSERT INTO `incidentreport`.`tbl_fireextinguisher` (`MachineName`, `TagNo`, `Location`, `Type`, `capacity`, `manufactureDate`, `RefillDueDate`, `InspectionTagCheck`, `lastMaintenanceDate`,  `InspectionDate`, `InspectionFrequency`,  `Remark`) VALUES ('${machineName.text}', '${machineTag.text}', '${location.text}', '${type.text}', '${capacity.text}', '${selectedDate1}', '${selectedDate2}', '0', '${selectedDate1}',  '2020-10-31 15:50:18.000', 'Yearly', 'need maintance')";
...
//                    },
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: type,
                      validator: (value){
                        return value.length>3 ? null : "Please Enter Proper Type";
                      },
                      decoration: new InputDecoration(
                        border: new OutlineInputBorder(
                            borderSide: new BorderSide(color: Colors.teal)
                        ),
                        hintText: 'Tell us about type',
                        labelText: 'Type',
                        prefixIcon: const Icon(Icons.filter_tilt_shift),
                      ),
                    ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: capacity,
                      validator: (value){
                        return value.length>3 ? null : "Please Enter Proper capacity";
                      },
                      decoration: new InputDecoration(
                        border: new OutlineInputBorder(
                            borderSide: new BorderSide(color: Colors.teal)
                        ),
                        hintText: 'Tell us about capacity',
                        labelText: 'Capacity',
                        prefixIcon: const Icon(Icons.filter_tilt_shift),
                      ),
                    ),
